...
## Full Summary — The Minimal Change Checklist Per Project

When you want to build a **new project** with a different dataset, you only need to complete these items:

```
[ ] Step 1   Write the business question
[ ] Step 2   Download the dataset
[ ] Step 3   Identify the target column name
[ ] Step 4   Load and explore the data in a notebook
[ ] Step 5   Clean the data (drop IDs, handle nulls)
[ ] Step 6   Encode the target as 0 / 1
[ ] Step 7   One-hot encode categorical columns
[ ] Step 8   Split and save train.csv, sample_test.csv, sample_test_labeled.csv
[ ] Step 9   Copy the 3 CSV files into backend/data/

[ ] Step 20  In docker-compose.yml: change --target, MODEL_NAME
[ ] Step 21  In frontend/app.py: change TITLE, TARGET_COL, LABELS

[ ] Steps 12–19  Copy unchanged (identical for every project)

[ ] Step 22  docker compose up --build
[ ] Step 23  docker compose ps  → trainer Exited (0)
[ ] Step 24  Open 3 URLs in browser
[ ] Step 25  Upload test CSV, confirm predictions
[ ] Step 26  Open MLflow, confirm @champion
[ ] Step 27  docker compose down
```
